...
---
验证结论 (2026-06-26, 全市场回测4910只/2022~2026/max5仓):
  收益 +96.97%  回撤 29.23%  胜率 41.38%  交易 58笔  盈利因子 2.32
  核心优势: 只在恐慌底出手(广度<25%), 低频高质量, 4年仅58笔交易
  与趋势跟随互补: 趋势跟随每日追涨(+11%), 大底抄底等恐慌(+97%)
=======
  买入 = 市场恐慌(广度<25%) + 深度超跌(MA60下方>8%) + 卖压衰竭(5日-8%~-1%)
  卖出 = 止损（ATR动态/恐慌分级/时间衰减）/ 移动止盈 / 90天到期
>>>>>>> 2c7514bf6f1c2b866fe8691cadb3b796e05b4175
"""
