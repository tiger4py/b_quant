...
策略流程：
  买入 = 趋势向上 + 量价齐升 + 位置合理
  卖出 = 止损/止盈/单日暴跌>8%/趋势破坏/量能崩塌/持仓到期

---
验证结论 (2026-06-24, 全市场回测4906只/1000天/max5仓):
  收益 +11.10%  回撤 52.90%  胜率 43.57%  交易 723笔  盈利因子 1.03
  最大出血点: 跌破MA20(243笔,-176万) + 止损(94笔,-158万)
  利润来源: 止盈(39笔,+188万) 撑起全部利润
  核心瓶颈: 止盈和止损在买入点特征高度重叠, 简单维度无法事前区分
"""
...
META = {
    "id": "trend_following",
    "name": "趋势跟随",
    "description": "趋势向上+量价齐升：5日涨>1%、20日趋势不差、40日回撤<20%、量比>1.3、涨跌量比>1.1、站上MA20、接近20日高点。次日收盘价买入（不含信号日收益）。卖出：止损-8%/止盈+25%/趋势破坏/量能崩塌/高位回撤。",
}
